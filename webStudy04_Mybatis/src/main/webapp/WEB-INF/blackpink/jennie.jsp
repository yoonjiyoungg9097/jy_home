	...
	<div class="people_info section people_spc" id="people_info_z"
		...
		<div class="cont_noline" style="z-index: 10">
			<div class="profile_wrap">
				<div class="big_thumb">
					<a nocr=""
						onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_317583+'.image&amp;i='+'1800000D_00000004D88F');"
						href="https://image.search.naver.com/search.naver?where=image&amp;query=BLACKPINK+%EC%A0%9C%EB%8B%88&amp;merge=0&amp;res_fr=0&amp;res_to=0&amp;sort=0&amp;viewtype=0&amp;site=&amp;face=1&amp;color=0&amp;mcs=0&amp;a_q=&amp;n_q=&amp;o_q=&amp;sm=tab_etc"><img
						src="https://search.pstatic.net/common?type=a&amp;size=120x150&amp;quality=95&amp;direct=true&amp;src=http%3A%2F%2Fsstatic.naver.net%2Fpeople%2F15%2F201807021856047861.jpg"
						alt="가수 제니 이미지" width="120" height="150"
						onerror="tx_noimage_thumb(this, 'sp_noimg', 'https://ssl.pstatic.net/sstatic/search/images11/blank.gif');"></a>
					<a nocr=""
						onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_317583+'.edit&amp;i='+'1800000D_00000004D88F');"
						class="btn_profile_update" href="http://myprofile.naver.com"
						target="_blank"><span class="blind">가수 제니</span>내 프로필 수정</a>
				</div>
				<dl class="detail_profile">
					<dd class="name">
						<a nocr=""
							onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_317583+'.namepeople&amp;i='+'1800000D_00000004D88F');"
							href="https://people.search.naver.com/search.naver?where=nexearch&amp;query=%EC%A0%9C%EB%8B%88&amp;sm=tab_etc&amp;ie=utf8&amp;key=PeopleService&amp;os=317583"
							target="_blank"><strong>제니</strong></a> <span class="name_more">(JENNIE)</span>
						<span>가수</span>
					</dd>
					<dt>소속그룹</dt>
					<dd>
						<a nocr=""
							onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_317583+'.group&amp;i='+'1800000D_00000004D88F');"
							href="?where=nexearch&amp;sm=tab_etc&amp;mra=bjky&amp;pkid=1&amp;os=3750644&amp;query=BLACKPINK">BLACKPINK</a>
					</dd>
					<dt>소속사</dt>
					<dd>
						<a nocr=""
							onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_317583+'.management&amp;i='+'1800000D_00000004D88F');"
							href="?where=nexearch&amp;sm=tab_etc&amp;query=YG%EC%97%94%ED%84%B0%ED%85%8C%EC%9D%B8%EB%A8%BC%ED%8A%B8">YG엔터테인먼트</a>
					</dd>
					<dt>사이트</dt>
					<dd>
						<a nocr=""
							onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_317583+'.vlive&amp;i='+'1800000D_00000004D88F');"
		...
		<div class="go_relate">
				...
				<div style="left: -65px; width: 286px; visibility: hidden;"
					...
					<div class="layer_tooltip2">
						<div class="content">
							...
							<a nocr=""
								onclick="return goOtherCR(this, 'a=nco_x29*3.imaginfmy&amp;r=1&amp;i=1800000D_00000004D88F&amp;u=' + urlencode(this.href));"
								href="https://myprofile.naver.com/Main.nhn" class="request"
								target="_blank">본인 및 소속사의 인물정보 수정요청</a> <a nocr=""
								onclick="return goOtherCR(this, 'a=nco_x29*3.imaginfcs&amp;r=1&amp;i=1800000D_00000004D88F&amp;u=' + urlencode(this.href));"
			...
			<script type="text/javascript">
				...
				function fnLayerOpen(e) {
					...
					goOtherTCR(this,
							'a=nco_x29*3.imaginf&r=1&i=1800000D_00000004D88F');
				}
				function fnLayerClose(e) {
					$('tooltip_layer').style.visibility = "hidden";
					$('more_div_btn').focus();
					goOtherTCR(this,
							'a=nco_x29*3.imaginfclose&r=1&i=1800000D_00000004D88F');
				}
			</script>
			<a nocr=""
				onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_317583+'.profiledetail&amp;i='+'1800000D_00000004D88F');"
				href="https://people.search.naver.com/search.naver?where=nexearch&amp;query=%EC%A0%9C%EB%8B%88&amp;sm=tab_etc&amp;ie=utf8&amp;key=PeopleService&amp;os=317583"
				class="btn_txt_more" target="_blank"><span class="blind">가수
					제니</span>프로필 더보기</a>
		</div>
		<script type="text/javascript">
			var __sDefaultPeopleTab = "앨범";
		</script>
		<div class="people_type" id="tx_ca_people_workall">
			<div class="texttab_type">
				<ul>
					<li id="tx_ca_people_tvcast_tab"><a nocr="1" href="#"
						class="pg_btn">네이버TV</a></li>
					<li id="tx_ca_people_album_tab" class="select"><a nocr="1"
						href="#" class="pg_btn">앨범</a></li>
					<li id="tx_ca_people_play_tab"><a nocr="1" href="#"
						class="pg_btn">공연</a></li>
				</ul>
			</div>
			<div class="lst_cont tvcast " style="display: none;">
				<h3 class="blind">네이버TV</h3>
				<ul>
					<li>
						<div class="thumb_box">
							<a nocr=""
								onclick="return goOtherCR(this, 'a=nco_x29*3.tvcimg&amp;r=1&amp;i=1800000D_00000004D88F&amp;u=' + urlencode(this.href));"
						...
						<div class="txt_box">
							<a nocr=""
								onclick="return goOtherCR(this, 'a=nco_x29*3.tvctit&amp;r=1&amp;i=1800000D_00000004D88F&amp;u=' + urlencode(this.href));"
					...
					<li>
						<div class="thumb_box">
							<a nocr=""
								onclick="return goOtherCR(this, 'a=nco_x29*3.tvcimg&amp;r=1&amp;i=1800000D_00000004D88F&amp;u=' + urlencode(this.href));"
								target="_blank" href="https://tv.naver.com/v/3807124"> <img
								src="https://search.pstatic.net/common?type=ofullfill_black&amp;size=128x72&amp;quality=95&amp;direct=true&amp;src=https%3A%2F%2Fphinf.pstatic.net%2Ftvcast%2F20180812_71%2FdrTFZ_1534067789436NH73M_JPEG%2FVD13741968_w1280.jpg"
								alt="‘이열치열 밖캉스’ 한 여름에 패딩·모닥불 고구마 파티" width="128" height="72"
								onerror="tx_noimage_thumb(this, 'sp_noimg', 'https://ssl.pstatic.net/sstatic/search/images11/blank.gif');"
								class=""> <span class="ico_play"></span> <span
								class="runtime"><span class="bg">재생시간</span><em>2분
										37초</em></span> <span class="img_bd"></span>
							</a>
						</div>
						<div class="txt_box">
							<a nocr=""
								onclick="return goOtherCR(this, 'a=nco_x29*3.tvctit&amp;r=1&amp;i=1800000D_00000004D88F&amp;u=' + urlencode(this.href));"
								target="_blank" href="https://tv.naver.com/v/3807124"
								class="cast_txt">‘이열치열 밖캉스’ 한 여름에 패딩·모닥불...</a> <span
								class="day_txt">2018.08.12.</span>
						</div>
					</li>
					<li>
						<div class="thumb_box">
							<a nocr=""
								onclick="return goOtherCR(this, 'a=nco_x29*3.tvcimg&amp;r=1&amp;i=1800000D_00000004D88F&amp;u=' + urlencode(this.href));"
								target="_blank" href="https://tv.naver.com/v/3807077"> <img
								src="https://search.pstatic.net/common?type=ofullfill_black&amp;size=128x72&amp;quality=95&amp;direct=true&amp;src=https%3A%2F%2Fphinf.pstatic.net%2Ftvcast%2F20180812_21%2FUgyRG_1534067493031YB5HD_JPEG%2FVD56724142_w1280.jpg"
								alt="이광수, 제니 따라 하는 전소민 유혹에 ‘거침없는 패대기’" width="128" height="72"
								onerror="tx_noimage_thumb(this, 'sp_noimg', 'https://ssl.pstatic.net/sstatic/search/images11/blank.gif');"
								class=""> <span class="ico_play"></span> <span
								class="runtime"><span class="bg">재생시간</span><em>2분
						...
						<div class="txt_box">
							<a nocr=""
								onclick="return goOtherCR(this, 'a=nco_x29*3.tvctit&amp;r=1&amp;i=1800000D_00000004D88F&amp;u=' + urlencode(this.href));"
								target="_blank" href="https://tv.naver.com/v/3807077"
								class="cast_txt">이광수, 제니 따라 하는 전소민 유혹에 ‘...</a> <span
								class="day_txt">2018.08.12.</span>
						</div>
					</li>
				</ul>
				<a nocr=""
					onclick="return goOtherCR(this, 'a=nco_x29*3.tvcmore&amp;r=1&amp;i=1800000D_00000004D88F&amp;u=' + urlencode(this.href));"
					target="_blank" class="more_view"
					href="http://tv.naver.com/search/clip?query=제니&amp;sort=date"><span
			...
			<div class="lst_cont albumlist" id="tx_ca_people_album_content"
				...
				<ul>
					<li>
						<div class="thumb">
							<a nocr=""
								onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_317583+'.albumimage&amp;i='+'1800000D_00000004D88F');"
								href="https://music.naver.com/album/index.nhn?albumId=2623361"
								target="_blank"><img
								src="https://search.pstatic.net/common?type=o&amp;size=78x71&amp;quality=95&amp;direct=true&amp;src=https%3A%2F%2Fmusicmeta-phinf.pstatic.net%2Falbum%2F002%2F623%2F2623361.jpg%3Ftype%3Dr300Fll%26v%3D20181112175905"
								alt="SOLO" width="78" height="71"
								onerror="tx_noimage_thumb(this, 'sp_noimg', 'https://ssl.pstatic.net/sstatic/search/images11/blank.gif');"
						...
						<dl>
							<dt>
								<a nocr=""
									onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_317583+'.albumtitle&amp;i='+'1800000D_00000004D88F');"
									class="sh_people_title sh_people_link"
									href="https://music.naver.com/album/index.nhn?albumId=2623361"
									target="_blank">SOLO</a>
							</dt>
							<dd>제니(JENNIE)</dd>
							<dd>2018.11.12</dd>
						</dl>
			...
			<div class="lst_cont" id="tx_ca_people_play_content"
				...
				<ul>
					<li>
						<div class="big_thumb">
							<a nocr=""
								onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_317583+'.playimage&amp;i='+'1800000D_00000004D88F');"
						...
						<dl>
							<dd>
								<a nocr=""
									onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_317583+'.playtitle&amp;i='+'1800000D_00000004D88F');"
									class="sh_people_title sh_people_link"
									href="http://ygfamily.com/notice/NList.asp?LANGDIV=K&amp;IDX=12018&amp;STYPE=A"
									target="_blank"
