	...
	<div class="people_info section people_spc" id="people_info_z"
		...
		<div class="cont_noline" style="z-index: 10">
			<div class="profile_wrap">
				<div class="big_thumb">
					<img
						src="https://search.pstatic.net/common?type=a&amp;size=120x150&amp;quality=95&amp;direct=true&amp;src=http%3A%2F%2Fsstatic.naver.net%2Fpeople%2F120%2F201807021858352571.jpg"
						alt="가수 리사 이미지" width="120" height="150"
						onerror="tx_noimage_thumb(this, 'sp_noimg', 'https://ssl.pstatic.net/sstatic/search/images11/blank.gif');"><a
						nocr=""
						onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_3750651+'.edit&amp;i='+'1800000D_000000393AFB');"
						class="btn_profile_update" href="http://myprofile.naver.com"
						target="_blank"><span class="blind">가수 리사</span>내 프로필 수정</a>
				</div>
				<dl class="detail_profile">
					<dd class="name">
						<a nocr=""
							onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_3750651+'.namepeople&amp;i='+'1800000D_000000393AFB');"
							href="https://people.search.naver.com/search.naver?where=nexearch&amp;query=%EB%A6%AC%EC%82%AC&amp;sm=tab_etc&amp;ie=utf8&amp;key=PeopleService&amp;os=3750651"
							target="_blank"><strong>리사</strong></a> <span class="name_more">(LISA)</span>
						<span>가수</span>
					</dd>
					<dt>소속그룹</dt>
					<dd>
						<a nocr=""
							onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_3750651+'.group&amp;i='+'1800000D_000000393AFB');"
							href="?where=nexearch&amp;sm=tab_etc&amp;mra=bjky&amp;pkid=1&amp;os=3750644&amp;query=BLACKPINK">BLACKPINK</a>
					</dd>
					<dt>소속사</dt>
					<dd>
						<a nocr=""
							onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_3750651+'.management&amp;i='+'1800000D_000000393AFB');"
							href="?where=nexearch&amp;sm=tab_etc&amp;query=YG%EC%97%94%ED%84%B0%ED%85%8C%EC%9D%B8%EB%A8%BC%ED%8A%B8">YG엔터테인먼트</a>
					</dd>
					<dt>사이트</dt>
					<dd>
						<a nocr=""
							onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_3750651+'.vlive&amp;i='+'1800000D_000000393AFB');"
		...
		<div class="go_relate">
				...
				<div style="left: -65px; width: 286px; visibility: hidden;"
					...
					<div class="layer_tooltip2">
						<div class="content">
							...
							<a nocr=""
								onclick="return goOtherCR(this, 'a=nco_x29*3.imaginfmy&amp;r=1&amp;i=1800000D_000000393AFB&amp;u=' + urlencode(this.href));"
								href="https://myprofile.naver.com/Main.nhn" class="request"
								target="_blank">본인 및 소속사의 인물정보 수정요청</a> <a nocr=""
								onclick="return goOtherCR(this, 'a=nco_x29*3.imaginfcs&amp;r=1&amp;i=1800000D_000000393AFB&amp;u=' + urlencode(this.href));"
			...
			<script type="text/javascript">
				...
				function fnLayerOpen(e) {
					...
					goOtherTCR(this,
							'a=nco_x29*3.imaginf&r=1&i=1800000D_000000393AFB');
				}
				function fnLayerClose(e) {
					$('tooltip_layer').style.visibility = "hidden";
					$('more_div_btn').focus();
					goOtherTCR(this,
							'a=nco_x29*3.imaginfclose&r=1&i=1800000D_000000393AFB');
				}
			</script>
			<a nocr=""
				onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_3750651+'.profiledetail&amp;i='+'1800000D_000000393AFB');"
				href="https://people.search.naver.com/search.naver?where=nexearch&amp;query=%EB%A6%AC%EC%82%AC&amp;sm=tab_etc&amp;ie=utf8&amp;key=PeopleService&amp;os=3750651"
			...
			<div class="lst_cont tvcast " style="display: block;">
				...
				<ul>
					<li>
						<div class="thumb_box">
							<a nocr=""
								onclick="return goOtherCR(this, 'a=nco_x29*3.tvcimg&amp;r=1&amp;i=1800000D_000000393AFB&amp;u=' + urlencode(this.href));"
								target="_blank" href="https://tv.naver.com/v/4424488"> <img
								src="https://search.pstatic.net/common?type=ofullfill_black&amp;size=128x72&amp;quality=95&amp;direct=true&amp;src=https%3A%2F%2Fphinf.pstatic.net%2Ftvcast%2F20181102_189%2FbgH71_15411666950150wbql_JPEG%2FT9201811020089.jpg"
								alt="벌레의 생명도 소중한 평화리사, 잘가 벌레야..☆" width="128" height="72"
								...
								class="runtime"><span class="bg">재생시간</span><em>2분
										53초</em></span> <span class="img_bd"></span>
							</a>
						</div>
						<div class="txt_box">
							<a nocr=""
								onclick="return goOtherCR(this, 'a=nco_x29*3.tvctit&amp;r=1&amp;i=1800000D_000000393AFB&amp;u=' + urlencode(this.href));"
								target="_blank" href="https://tv.naver.com/v/4424488"
								class="cast_txt">벌레의 생명도 소중한 평화리사, 잘가 벌레...</a> <span
					...
					<li>
						<div class="thumb_box">
							<a nocr=""
								onclick="return goOtherCR(this, 'a=nco_x29*3.tvcimg&amp;r=1&amp;i=1800000D_000000393AFB&amp;u=' + urlencode(this.href));"
								target="_blank" href="https://tv.naver.com/v/4424441"> <img
								src="https://search.pstatic.net/common?type=ofullfill_black&amp;size=128x72&amp;quality=95&amp;direct=true&amp;src=https%3A%2F%2Fphinf.pstatic.net%2Ftvcast%2F20181102_195%2FolO4w_1541166100851UYawF_JPEG%2FT9201811020086.jpg"
								alt="드론으로 홈런 날려버리는 리사?! 넘어갔습니다ㅠㅅㅠ" width="128" height="72"
								onerror="tx_noimage_thumb(this, 'sp_noimg', 'https://ssl.pstatic.net/sstatic/search/images11/blank.gif');"
								class=""> <span class="ico_play"></span> <span
								class="runtime"><span class="bg">재생시간</span><em>2분
										46초</em></span> <span class="img_bd"></span>
							</a>
						</div>
						<div class="txt_box">
							<a nocr=""
								onclick="return goOtherCR(this, 'a=nco_x29*3.tvctit&amp;r=1&amp;i=1800000D_000000393AFB&amp;u=' + urlencode(this.href));"
								target="_blank" href="https://tv.naver.com/v/4424441"
								class="cast_txt">드론으로 홈런 날려버리는 리사?! 넘어갔습...</a> <span
								class="day_txt">2018.11.02.</span>
						</div>
					</li>
					<li>
						<div class="thumb_box">
							<a nocr=""
								onclick="return goOtherCR(this, 'a=nco_x29*3.tvcimg&amp;r=1&amp;i=1800000D_000000393AFB&amp;u=' + urlencode(this.href));"
								target="_blank" href="https://tv.naver.com/v/4424353"> <img
								src="https://search.pstatic.net/common?type=ofullfill_black&amp;size=128x72&amp;quality=95&amp;direct=true&amp;src=https%3A%2F%2Fphinf.pstatic.net%2Ftvcast%2F20181102_36%2F0MzAE_1541165196248cNvaV_JPEG%2FT9201811020080.jpg"
								alt="홍석이에겐 슬픈 이야기가 하나 있어.. 지워지지 않아.." width="128" height="72"
								onerror="tx_noimage_thumb(this, 'sp_noimg', 'https://ssl.pstatic.net/sstatic/search/images11/blank.gif');"
								class=""> <span class="ico_play"></span> <span
								class="runtime"><span class="bg">재생시간</span><em>2분
										32초</em></span> <span class="img_bd"></span>
							</a>
						</div>
						<div class="txt_box">
							<a nocr=""
								onclick="return goOtherCR(this, 'a=nco_x29*3.tvctit&amp;r=1&amp;i=1800000D_000000393AFB&amp;u=' + urlencode(this.href));"
								target="_blank" href="https://tv.naver.com/v/4424353"
								class="cast_txt">홍석이에겐 슬픈 이야기가 하나 있어.. 지...</a> <span
								class="day_txt">2018.11.02.</span>
						</div>
					</li>
					<li>
						<div class="thumb_box">
							<a nocr=""
								onclick="return goOtherCR(this, 'a=nco_x29*3.tvcimg&amp;r=1&amp;i=1800000D_000000393AFB&amp;u=' + urlencode(this.href));"
								target="_blank" href="https://tv.naver.com/v/4424274"> <img
								src="https://search.pstatic.net/common?type=ofullfill_black&amp;size=128x72&amp;quality=95&amp;direct=true&amp;src=https%3A%2F%2Fphinf.pstatic.net%2Ftvcast%2F20181102_238%2FGqPys_1541164595976jAc3N_JPEG%2FT9201811020076.jpg"
								alt="악바리 이유비, 화생방 입실 50초만에 퇴실?!" width="128" height="72"
								onerror="tx_noimage_thumb(this, 'sp_noimg', 'https://ssl.pstatic.net/sstatic/search/images11/blank.gif');"
								class=""> <span class="ico_play"></span> <span
								class="runtime"><span class="bg">재생시간</span><em>2분
										51초</em></span> <span class="img_bd"></span>
							</a>
						</div>
						<div class="txt_box">
							<a nocr=""
								onclick="return goOtherCR(this, 'a=nco_x29*3.tvctit&amp;r=1&amp;i=1800000D_000000393AFB&amp;u=' + urlencode(this.href));"
								target="_blank" href="https://tv.naver.com/v/4424274"
								class="cast_txt">악바리 이유비, 화생방 입실 50초만에 퇴...</a> <span
								class="day_txt">2018.11.02.</span>
						</div>
					</li>
				</ul>
				<a nocr=""
					onclick="return goOtherCR(this, 'a=nco_x29*3.tvcmore&amp;r=1&amp;i=1800000D_000000393AFB&amp;u=' + urlencode(this.href));"
					target="_blank" class="more_view"
					href="http://tv.naver.com/search/clip?query=리사&amp;sort=date"><span
			...
			<div class="lst_cont albumlist" id="tx_ca_people_album_content"
				...
				<ul>
					<li>
						<div class="thumb">
							<a nocr=""
								onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_3750651+'.albumimage&amp;i='+'1800000D_000000393AFB');"
						...
						<dl>
							<dt>
								<a nocr=""
									onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_3750651+'.albumtitle&amp;i='+'1800000D_000000393AFB');"
				...
				<a nocr=""
					onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_3750651+'.wtmusicmore&amp;i='+'1800000D_000000393AFB');"
					class="more_view"
			...
			<div class="lst_cont" id="tx_ca_people_onair_content"
				...
				<ul>
					<li>
						<div class="big_thumb">
							<a nocr=""
								onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_3750651+'.dramaimage&amp;i='+'1800000D_000000393AFB');"
								href="?where=nexearch&amp;sm=tab_etc&amp;mra=bjkw&amp;x_csa=%7B%22pkid%22%3A%2257%22%2C%22os%22%3A%228642914%22%7D&amp;pkid=57&amp;os=8642914&amp;query=%EC%A7%84%EC%A7%9C%EC%82%AC%EB%82%98%EC%9D%B4300"><img
								src="https://search.pstatic.net/common?type=o&amp;size=58x82&amp;quality=95&amp;direct=true&amp;src=http%3A%2F%2Fsstatic.naver.net%2Fkeypage%2Fimage%2Fdss%2F57%2F64%2F29%2F14%2F57_8642914_poster_image_1541638533278.jpg"
								alt="진짜 사나이 300" width="58" height="82"
								onerror="tx_noimage_thumb(this, 'sp_noimg', 'https://ssl.pstatic.net/sstatic/search/images11/blank.gif');"
								class=""></a>
						</div>
						<dl>
							<dd>
								<a nocr=""
									onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_3750651+'.dramatitle&amp;i='+'1800000D_000000393AFB');"
									href="?where=nexearch&amp;sm=tab_etc&amp;mra=bjkw&amp;x_csa=%7B%22pkid%22%3A%2257%22%2C%22os%22%3A%228642914%22%7D&amp;pkid=57&amp;os=8642914&amp;query=%EC%A7%84%EC%A7%9C%EC%82%AC%EB%82%98%EC%9D%B4300">진짜
									사나이 300</a>
							</dd>
							<dd>2018</dd>
						</dl>
			...
			<div class="lst_cont" id="tx_ca_people_play_content"
				...
				<ul>
					<li>
						<div class="big_thumb">
							<a nocr=""
								onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_3750651+'.playimage&amp;i='+'1800000D_000000393AFB');"
						...
						<dl>
							<dd>
								<a nocr=""
									onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_3750651+'.playtitle&amp;i='+'1800000D_000000393AFB');"
									class="sh_people_title sh_people_link"
									href="http://ygfamily.com/notice/NList.asp?LANGDIV=K&amp;IDX=12018&amp;STYPE=A"
									target="_blank"
