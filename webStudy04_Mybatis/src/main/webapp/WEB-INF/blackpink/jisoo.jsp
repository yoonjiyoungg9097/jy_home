	...
	<div class="people_info section people_spc" id="people_info_z"
		...
		<div class="cont_noline" style="z-index: 10">
			<div class="profile_wrap">
				<div class="big_thumb">
					<img
						src="https://search.pstatic.net/common?type=a&amp;size=120x150&amp;quality=95&amp;direct=true&amp;src=http%3A%2F%2Fsstatic.naver.net%2Fpeople%2F133%2F201807021857013281.jpg"
						alt="가수 지수 이미지" width="120" height="150"
						onerror="tx_noimage_thumb(this, 'sp_noimg', 'https://ssl.pstatic.net/sstatic/search/images11/blank.gif');"><a
						nocr=""
						onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_552991+'.edit&amp;i='+'1800000D_00000008701F');"
						class="btn_profile_update" href="http://myprofile.naver.com"
						target="_blank"><span class="blind">가수 지수</span>내 프로필 수정</a>
				</div>
				<dl class="detail_profile">
					<dd class="name">
						<a nocr=""
							onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_552991+'.namepeople&amp;i='+'1800000D_00000008701F');"
							href="https://people.search.naver.com/search.naver?where=nexearch&amp;query=%EC%A7%80%EC%88%98&amp;sm=tab_etc&amp;ie=utf8&amp;key=PeopleService&amp;os=552991"
							target="_blank"><strong>지수</strong></a> <span class="name_more">(JISOO)</span>
						<span>가수</span>
					</dd>
					<dt>소속그룹</dt>
					<dd>
						<a nocr=""
							onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_552991+'.group&amp;i='+'1800000D_00000008701F');"
							href="?where=nexearch&amp;sm=tab_etc&amp;mra=bjky&amp;pkid=1&amp;os=3750644&amp;query=BLACKPINK">BLACKPINK</a>
					</dd>
					<dt>소속사</dt>
					<dd>
						<a nocr=""
							onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_552991+'.management&amp;i='+'1800000D_00000008701F');"
							href="?where=nexearch&amp;sm=tab_etc&amp;query=YG%EC%97%94%ED%84%B0%ED%85%8C%EC%9D%B8%EB%A8%BC%ED%8A%B8">YG엔터테인먼트</a>
					</dd>
					<dt>사이트</dt>
					<dd>
						<a nocr=""
							onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_552991+'.vlive&amp;i='+'1800000D_00000008701F');"
		...
		<div class="go_relate">
				...
				<div style="left: -65px; width: 286px; visibility: hidden;"
					...
					<div class="layer_tooltip2">
						<div class="content">
							...
							<a nocr=""
								onclick="return goOtherCR(this, 'a=nco_x29*3.imaginfmy&amp;r=1&amp;i=1800000D_00000008701F&amp;u=' + urlencode(this.href));"
								href="https://myprofile.naver.com/Main.nhn" class="request"
								target="_blank">본인 및 소속사의 인물정보 수정요청</a> <a nocr=""
								onclick="return goOtherCR(this, 'a=nco_x29*3.imaginfcs&amp;r=1&amp;i=1800000D_00000008701F&amp;u=' + urlencode(this.href));"
			...
			<script type="text/javascript">
				...
				function fnLayerOpen(e) {
					...
					goOtherTCR(this,
							'a=nco_x29*3.imaginf&r=1&i=1800000D_00000008701F');
				}
				function fnLayerClose(e) {
					$('tooltip_layer').style.visibility = "hidden";
					$('more_div_btn').focus();
					goOtherTCR(this,
							'a=nco_x29*3.imaginfclose&r=1&i=1800000D_00000008701F');
				}
			</script>
			<a nocr=""
				onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_552991+'.profiledetail&amp;i='+'1800000D_00000008701F');"
				href="https://people.search.naver.com/search.naver?where=nexearch&amp;query=%EC%A7%80%EC%88%98&amp;sm=tab_etc&amp;ie=utf8&amp;key=PeopleService&amp;os=552991"
			...
			<div class="lst_cont tvcast " style="display: block;">
				...
				<ul>
					<li>
						<div class="thumb_box">
							<a nocr=""
								onclick="return goOtherCR(this, 'a=nco_x29*3.tvcimg&amp;r=1&amp;i=1800000D_00000008701F&amp;u=' + urlencode(this.href));"
						...
						<div class="txt_box">
							<a nocr=""
								onclick="return goOtherCR(this, 'a=nco_x29*3.tvctit&amp;r=1&amp;i=1800000D_00000008701F&amp;u=' + urlencode(this.href));"
					...
					<li>
						<div class="thumb_box">
							<a nocr=""
								onclick="return goOtherCR(this, 'a=nco_x29*3.tvcimg&amp;r=1&amp;i=1800000D_00000008701F&amp;u=' + urlencode(this.href));"
								target="_blank" href="https://tv.naver.com/v/3898648"> <img
								src="https://search.pstatic.net/common?type=ofullfill_black&amp;size=128x72&amp;quality=95&amp;direct=true&amp;src=https%3A%2F%2Fphinf.pstatic.net%2Ftvcast%2F20180825_210%2Ft8tRP_1535200346642i4JF8_JPEG%2FB120188696_EPI0021_20_B.jpg"
								alt="이래도 힌트 안줘? 애교철철 로제 오빠~♥" width="128" height="72"
								onerror="tx_noimage_thumb(this, 'sp_noimg', 'https://ssl.pstatic.net/sstatic/search/images11/blank.gif');"
								class=""> <span class="ico_play"></span> <span
						...
						<div class="txt_box">
							<a nocr=""
								onclick="return goOtherCR(this, 'a=nco_x29*3.tvctit&amp;r=1&amp;i=1800000D_00000008701F&amp;u=' + urlencode(this.href));"
								target="_blank" href="https://tv.naver.com/v/3898648"
								class="cast_txt">이래도 힌트 안줘? 애교철철 로제 오빠~♥</a> <span
								class="day_txt">2018.08.25.</span>
						</div>
					</li>
					<li>
						<div class="thumb_box">
							<a nocr=""
								onclick="return goOtherCR(this, 'a=nco_x29*3.tvcimg&amp;r=1&amp;i=1800000D_00000008701F&amp;u=' + urlencode(this.href));"
								target="_blank" href="https://tv.naver.com/v/3898623"> <img
								src="https://search.pstatic.net/common?type=ofullfill_black&amp;size=128x72&amp;quality=95&amp;direct=true&amp;src=https%3A%2F%2Fphinf.pstatic.net%2Ftvcast%2F20180825_270%2FHpS2A_1535200048753Bdep0_JPEG%2FB120188696_EPI0021_19_B.jpg"
								alt="힌트를 얻기 위한 로제의 몸부림! 신기방기!" width="128" height="72"
								onerror="tx_noimage_thumb(this, 'sp_noimg', 'https://ssl.pstatic.net/sstatic/search/images11/blank.gif');"
								class=""> <span class="ico_play"></span> <span
								class="runtime"><span class="bg">재생시간</span><em>2분
										30초</em></span> <span class="img_bd"></span>
							</a>
						</div>
						<div class="txt_box">
							<a nocr=""
								onclick="return goOtherCR(this, 'a=nco_x29*3.tvctit&amp;r=1&amp;i=1800000D_00000008701F&amp;u=' + urlencode(this.href));"
								target="_blank" href="https://tv.naver.com/v/3898623"
								class="cast_txt">힌트를 얻기 위한 로제의 몸부림! 신기방기!</a> <span
								class="day_txt">2018.08.25.</span>
						</div>
					</li>
				</ul>
				<a nocr=""
					onclick="return goOtherCR(this, 'a=nco_x29*3.tvcmore&amp;r=1&amp;i=1800000D_00000008701F&amp;u=' + urlencode(this.href));"
					target="_blank" class="more_view"
					href="http://tv.naver.com/search/clip?query=지수&amp;sort=date"><span
			...
			<div class="lst_cont albumlist" id="tx_ca_people_album_content"
				...
				<ul>
					<li>
						<div class="thumb">
							<a nocr=""
								onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_552991+'.albumimage&amp;i='+'1800000D_00000008701F');"
						...
						<dl>
							<dt>
								<a nocr=""
									onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_552991+'.albumtitle&amp;i='+'1800000D_00000008701F');"
				...
				<a nocr=""
					onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_552991+'.wtmusicmore&amp;i='+'1800000D_00000008701F');"
					class="more_view"
			...
			<div class="lst_cont" id="tx_ca_people_onair_content"
				...
				<ul>
					<li>
						<div class="big_thumb">
							<a nocr=""
								onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_552991+'.dramaimage&amp;i='+'1800000D_00000008701F');"
								href="?where=nexearch&amp;sm=tab_etc&amp;mra=bjkw&amp;x_csa=%7B%22pkid%22%3A%2257%22%2C%22os%22%3A%22658960%22%7D&amp;pkid=57&amp;os=658960&amp;query=sbs%EC%9D%B8%EA%B8%B0%EA%B0%80%EC%9A%94"><img
								src="https://search.pstatic.net/common?type=o&amp;size=58x82&amp;quality=95&amp;direct=true&amp;src=http%3A%2F%2Fsstatic.naver.net%2Fkeypage%2Fimage%2Fdss%2F57%2F65%2F89%2F60%2F57_658960_poster_image_1541579927157.jpg"
								alt="SBS 인기가요" width="58" height="82"
								onerror="tx_noimage_thumb(this, 'sp_noimg', 'https://ssl.pstatic.net/sstatic/search/images11/blank.gif');"
								class=""></a>
						</div>
						<dl>
							<dd>
								<a nocr=""
									onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_552991+'.dramatitle&amp;i='+'1800000D_00000008701F');"
									href="?where=nexearch&amp;sm=tab_etc&amp;mra=bjkw&amp;x_csa=%7B%22pkid%22%3A%2257%22%2C%22os%22%3A%22658960%22%7D&amp;pkid=57&amp;os=658960&amp;query=sbs%EC%9D%B8%EA%B8%B0%EA%B0%80%EC%9A%94">SBS
									인기가요</a>
							</dd>
							<dt>진행</dt>
							<dd>2017 ~ 2018</dd>
			...
			<div class="lst_cont" id="tx_ca_people_play_content"
				...
				<ul>
					<li>
						<div class="big_thumb">
							<a nocr=""
								onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_552991+'.playimage&amp;i='+'1800000D_00000008701F');"
						...
						<dl>
							<dd>
								<a nocr=""
									onclick="return goOtherCR(this, 'u='+urlencode(this.href)+'&amp;r=1&amp;a='+nco_area_552991+'.playtitle&amp;i='+'1800000D_00000008701F');"
									class="sh_people_title sh_people_link"
									href="http://ygfamily.com/notice/NList.asp?LANGDIV=K&amp;IDX=12018&amp;STYPE=A"
									target="_blank"
